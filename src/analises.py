...
class GerenciadorAnalises:
    ...
    def executar_analise_conectividade(self) -> None:
        ...
        is_conexo, alcancados, total = self.grafo.verificar_conectividade()
    ...
    def executar_analise_gargalos(self, top_n: int = 5) -> None:
        ...
        top_cruzamentos = self.grafo.calcular_graus(top_n=top_n)
    ...
    def executar_analise_resiliencia(self, id_origem: int, id_destino: int) -> None:
        ...
        caminho_original, dist_original = self.dijkstra.executar(id_origem, id_destino)
        ...
        caminho_novo, dist_nova = self.dijkstra.executar(id_origem, id_destino, nos_ignorados=area_bloqueada)
